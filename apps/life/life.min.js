...
function setButtons(){setWatch(function(){load()},BTN1,{repeat:!1,edge:"falling"});setWatch(Bangle.showLauncher,BTN2,{repeat:!1,edge:"falling"});setWatch(regen,BTN3,{repeat:!0,edge:"rising"})}var SCREENACCESS={withApp:!0,request:function(){this.withApp=!1;stopdraw();clearWatch()},release:function(){this.withApp=!0;startdraw();setButtons()}};Bangle.on("lcdPower",function(c){SCREENACCESS.withApp&&(c?startdraw():stopdraw())});g.clear();Bangle.loadWidgets();startdraw(!0);setButtons();
buf.setFont("Vector",40);buf.setFontAlign(0,0);buf.drawString("LIFE",80,80);buf.setFont("6x8",2);buf.drawString("Conway's",80,20);buf.drawString("(Press RESET)",80,140);flip();
