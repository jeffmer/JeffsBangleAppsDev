...
function docalibrate(b){void 0===b&&(b=!1);stopdraw();E.showPrompt(" takes 30 seconds",{title:"Calibrate",buttons:{Start:!0,Cancel:!1}}).then(function(c){c||b?(buf.setColor(1),buf.setFont("Vector",24),buf.setFontAlign(0,-1),buf.drawString("Fig 8s to",120,0),buf.drawString("Calibrate",120,26),flip(buf,Yoff),calibrate().then(function(a){require("Storage").write("magnav.json",a);CALIBDATA=a;startdraw();setButtons()})):(startdraw(),setButtons())})}
