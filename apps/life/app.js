...
function flip() {
 g.drawImage({width:160,height:160,bpp:1,buffer:buf.buffer, palette:pal1color},40,60);
 buf.clear();
}
...
function howlong(){
  ...
  console.log('Render: '+duration+'ms');
}
*/
...
function startdraw() {
    ...
    intervalRefSec = setInterval(alternate,1000);
  }
