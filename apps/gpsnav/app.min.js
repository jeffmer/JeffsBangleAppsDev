...
function drawN(){buf.setColor(1);buf.setFont("6x8",2);buf.drawString("o",100,0);buf.setFont("6x8",1);buf.drawString("kph",220,40);buf.setFont("Vector",36);var a=course.toString();a=10>course?"00"+a:100>course?"0"+a:a;buf.drawString(a,10,0);a=10>speed?speed.toFixed(1):Math.round(speed);buf.drawString(a,140,4);flip(buf,Yoff+70);buf.setColor(1);buf.setFont("Vector",18);a=brg.toString();a=10>brg?"00"+a:100>brg?"0"+a:a;buf.setColor(3);buf.drawString("Brg: ",0,0);buf.drawString("Dist: ",0,30);buf.setColor(selected?
1:2);buf.drawString(wp.name,140,0);buf.setColor(1);buf.drawString(a,60,0);1E3>dist?buf.drawString(dist.toString()+"m",60,30):buf.drawString((dist/1E3).toFixed(2)+"Km",60,30);flip(buf,Yoff+130);g.setFont("6x8",1);g.setColor(0,0,0);g.fillRect(10,230,60,239);g.setColor(1,1,1);g.drawString("Sats "+satellites.toString(),10,230)}var savedfix;
